...
command_t disk_part_cmds[] = {{"help", cmd_disk_part_help, "show disk part commands"},
...
command_t disk_cmds[] = {{"help", cmd_disk_help, "show disk commands"},
...
// ==== Таблица команд ====
command_t commands[] = {{"help", cmd_help, "show this help"},
